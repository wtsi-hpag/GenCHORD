...
This tool was designed for analysing Chromothripsis in conjunction with the `steppingStone tool<https://github.com/wtsi-hpag/steppingStone>`_, but has applications outside of that usecase. 
