		...
		\subsection{Harmonic Fitting}
			...
			\subsection{The Global Model}
				...
				\subsection{Limitations of Separable Optimisation}
					...
					% There might be some concern that separable optimisation does not guarantee convergence to the same optimum as a simultaneous optimisation. In our case, however, since we permit $\{w_q\}$ to be free parameters.
