...
%%%%% copying the contents of the Jack Markup Library here for transport
	...
	\copyrightyear{2024}
	\acmYear{2024}
	\setcopyright{acmlicensed}\acmConference[ICCBB 2024]{2024 8th International Conference on Computational Biology and Bioinformatics}{November 28--30, 2024}{Kyoto, Japan}
	\acmBooktitle{2024 8th International Conference on Computational Biology and Bioinformatics (ICCBB 2024), November 28--30, 2024, Kyoto, Japan}
	\acmDOI{10.1145/3715020.3715051}
	\acmISBN{979-8-4007-0962-3/24/11}
...
\begin{document}
	...
	% 			\begin{spalign}
	% 				\widehat{f} & = \frac{1}{\sqrt{2\pi}}\int_{\infty}^\infty p(k) \exp(i k x)
	% 				\\
	% 				& = \frac{1}{\sqrt{2\pi}} \sum_{k^\prime = 0}^\infty \p(k^\prime) \exp(i k^\prime x) 
	% 			\end{spalign}
