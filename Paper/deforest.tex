...
\begin{document}
	...
	\section{Introduction}
		...
		In short, the aim of this work is to generate a computational tool which can peer through the `forest' of the coverage data, and see the underlying pattern.
		\begin{figure}
			\begin{center}
				\begin{tikzpicture}
